...
typedef struct env_info {
    ...
    int8_t max_sps;     /** < Maximum number of symmetric partitions */
    int8_t n_sps;       /** < Number of symmetric partitions */
    char **sp_specs;    /** < Symmetric partitions specs */
...
typedef struct heapinfo {
    ...
    symm_type_t *type;          /**< array of the types of the heaps/partitions */
} heapinfo_t;
